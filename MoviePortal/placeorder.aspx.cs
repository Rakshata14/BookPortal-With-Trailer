...
namespace MoviePortal
{
    public partial class placeorder : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["id"] != null)
                {
                    if (Session["Buyitems"] == null)
                    {
                        ...
                        dr = dt.NewRow();
                        String mycon = "Data Source=desktop-ks0i5h4;Initial Catalog=bookportal;Integrated Security=SSPI";
        ...
        public void saveaddress()
        {
            ...
            String mycon1 = "Data Source=desktop-ks0i5h4;Initial Catalog=bookportal;Integrated Security=SSPI";
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            saveaddress();
            Response.Redirect("PlacedSuccess.aspx");
        }
    }
}